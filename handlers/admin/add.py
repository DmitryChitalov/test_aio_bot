...
# обработчик вывода список категорий с кнопкой добавления категории
...
# обработчик перехода к добавлению категории
...
# обработчик перехода к отображению товаров категории
...
# обработчик отображения товаров категории
...
# обработчик добавления фото товара и перехода к добавлению цены
...
# валидатор-обработчик указания цены в
# неверном формате и возврата к замене фото
